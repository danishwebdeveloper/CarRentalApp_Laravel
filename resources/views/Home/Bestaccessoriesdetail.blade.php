...
@section('title', 'BEST Reveiwed Product')

@section('Maincontent')

  <div class="page-title">
    <h2>BEST SELLER PRODUCT Detail</h2>
  </div>
              ...
              <form action="#" method="post" id="product_addtocart_form">
                ...
                <div class="product-img-box col-lg-5 col-sm-5 col-xs-12">
                    ...
                    <div class="product-image">
                      <div class="product-full"> <img id="product-zoom" src="products-images/p35.jpg" data-zoom-image="products-images/p35.jpg" alt="product-image"/> </div>
